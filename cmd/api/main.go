...
import (
	...
	"github.com/mtechguy/final/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&setting.db.dsn, "db-dsn", "postgres://book_club_management:Cattalya03@localhost/book_club_management?sslmode=disable", "PostgreSQL DSN")
	...
	flag.Func("cors-trusted-origins", "Trusted CORS origins (space separated)",
		func(val string) error {
			setting.cors.trustedOrigins = strings.Fields(val)
			return nil
		})
